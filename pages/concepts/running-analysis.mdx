...
<video classNamecontrols width="100%">
  <source src="/images/analysis-light.mp4" type="video/mp4" />
</video>
</Frame>

<Frame className="hidden dark:block">
<video controls width="100%">
  <source src="/images/analysis-dark.mp4" type="video/mp4" />
</video>
</Frame>
...
For more recent references check: https://artificialanalysis.ai/models
