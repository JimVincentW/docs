---
title: "Infospaces"
description: "Organize projects into isolated workspaces with built-in vector search"
---

# Infospaces & Vector Storage

> Separate projects. Semantic search built in.

## What Are Infospaces?

Each infospace is a workspace - your assets, schemas, and analysis results stay isolated. Think of them as separate research projects, departments, or clients.

**Example:** A research organisation might have:
- **"Climate Policy Research"** - climate documents and analysis
- **"Election Coverage 2024"** - news articles and media tracking
- **"Grant Applications"** - funding requests under review
- **"Academic Papers"** - literature and methodology
...
Every infospace is also a vector store. Your documents get embedded - enabling semantic search, similarity matching, and AI-powered discovery.
