...
Assets are composable - they have parent-child relationships. A CSV is one file, but it's also individual rows you can analyse separately. A PDF is one document, but it's also pages. Most data you'd want to work with - mbox archives, article feeds, survey exports - can be broken down this way.
