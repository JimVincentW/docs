...
The Intelligence Chat system transforms Open Politics HQ from a static analysis platform into an interactive research assistant. AI models can search your data, run analysis workflows, generate reports, and curate findings - all through natural conversation.

This isn't just chatting about your data; it's giving AI models the ability to actively work with your intelligence collection through structured tool calls.
