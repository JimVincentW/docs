...
<img src="images/exactly.png" alt="Open Politics HQ Platform" />
...
```json Schema Definition
{
  "primary_source": {
    "type": "string",
    "description": "Primary source cited: [government, activist, expert, anonymous]"
  },
  "emotional_intensity": {
    "type": "number",
    "description": "Emotional intensity: 1-5 scale"
  },
  "final_word": {
    "type": "string",
    "description": "Which side gets final word"
  }
}
```
...
```json Sample Output
{
  ...
  "final_word": "pro-government"
}
```
</CodeGroup>

<img src="/images/dash-1.png" alt="Table with annotation" />
...
<Steps>
  ...
  <Step title="Define Schemas">
    Describe what information to extract in plain language
  </Step>
